...
export default z.object({
	...
	keywords: z.array(z.string().describe("e.g. AngularJS")).describe("Specify special elements involved"),
	startDate: z.coerce.date(),
	endDate: z.coerce.date().optional(),
	url: z.string().url().optional().describe("e.g. http://www.computer.org/csdl/mags/co/1996/10/rx069-abs.html"),
	roles: z
